...
export const cropUtils = {
    ...
    // The function in OutpaintEditor_s1.jsx needs to be updated to match the old prototype
// This is the updated version of handleCropStart that should be put in OutpaintEditor_s1.jsx
...
const handleSize = 12 / canvasScale; // Slightly bigger handle area for better UX
const handles = [
...
setAutoAspectRatioCrop(false); // Disable aspect ratio when manually adjusting - like old prototype
return;
}
}
...
setAutoAspectRatioCrop(false); // Disable aspect ratio when creating new selection - like old prototype
},
